    ...
    <section lang="en" className="border-b border-border/60 py-24">
      <div className="container">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-pretty text-base leading-relaxed text-muted-foreground md:text-lg">
            API integrators should assume processing of data related to
            accounts, keys, and technical call metadata. The frames are
            described in the English summary in the{" "}
            <span className="whitespace-nowrap">medmcp-dev/core</span>{" "}
            repository. This page does not introduce a new source of truth; it
            only points to documentation.
          </p>
          <p className="mt-4 text-pretty text-base leading-relaxed text-muted-foreground md:text-lg">
            <a
              href={GDPR_SUMMARY_URL}
